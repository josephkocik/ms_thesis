...
input   out_r_empty_n;
output   out_r_read;
input  [31:0] y_h_str_dout;
input   y_h_str_empty_n;
output   y_h_str_read;
...
reg   [0:0] icmp_ln315_reg_227;
reg   [0:0] icmp_ln315_reg_227_pp0_iter1_reg;
reg    gmem_blk_n_B;
...
reg   [0:0] icmp_ln311_reg_223;
reg   [17:0] i_reg_110;
reg   [223:0] phi_ln315_reg_121;
reg   [26:0] trunc_ln_reg_207;
wire   [17:0] add_ln311_fu_153_p2;
...
wire   [0:0] icmp_ln311_fu_159_p2;
reg   [0:0] icmp_ln311_reg_223_pp0_iter1_reg;
wire   [0:0] icmp_ln315_fu_169_p2;
reg   [31:0] tmp_reg_232;
wire   [223:0] select_ln315_fu_200_p3;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state3;
wire  signed [31:0] sext_ln311_fu_143_p1;
reg    ap_block_pp0_stage0_01001;
reg    ap_block_state1;
wire   [2:0] trunc_ln311_fu_165_p1;
wire   [191:0] tmp_1_fu_183_p4;
wire   [223:0] tmp_2_fu_193_p3;
reg   [70:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
wire    ap_ce_reg;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state73) & (m_axi_gmem_BVALID == 1'b1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((m_axi_gmem_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
        i_reg_110 <= 18'd0;
    end else if (((icmp_ln311_fu_159_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((m_axi_gmem_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
        phi_ln315_reg_121 <= 224'd0;
    end else if (((icmp_ln311_reg_223_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln311_fu_159_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        icmp_ln315_reg_227 <= icmp_ln315_fu_169_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln311_reg_223 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        trunc_ln_reg_207 <= {{out_r_dout[31:5]}};
    end
end

always @ (*) begin
    if ((icmp_ln311_fu_159_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state73) & (m_axi_gmem_BVALID == 1'b1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((icmp_ln315_reg_227_pp0_iter1_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln315_reg_227_pp0_iter1_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln311_reg_223 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln311_reg_223 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        y_h_str_read = 1'b1;
    end else begin
        y_h_str_read = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((icmp_ln311_fu_159_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone)) & ~((ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln311_fu_159_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone)))) begin
...
assign add_ln311_fu_153_p2 = (i_reg_110 + 18'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((icmp_ln311_reg_223 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (y_h_str_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln311_reg_223 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (y_h_str_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln311_reg_223 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (y_h_str_empty_n == 1'b0)));
end
...
always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = ((icmp_ln311_reg_223 == 1'd0) & (y_h_str_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state5_io = ((icmp_ln315_reg_227_pp0_iter1_reg == 1'd1) & (m_axi_gmem_WREADY == 1'b0));
end
...
assign icmp_ln311_fu_159_p2 = ((i_reg_110 == 18'd134520) ? 1'b1 : 1'b0);

assign icmp_ln315_fu_169_p2 = ((trunc_ln311_fu_165_p1 == 3'd7) ? 1'b1 : 1'b0);
...
assign m_axi_gmem_AWADDR = sext_ln311_fu_143_p1;
...
assign m_axi_gmem_AWLEN = 32'd16815;
...
assign m_axi_gmem_WDATA = {{tmp_reg_232}, {phi_ln315_reg_121}};
...
assign select_ln315_fu_200_p3 = ((icmp_ln315_reg_227_pp0_iter1_reg[0:0] == 1'b1) ? 224'd0 : tmp_2_fu_193_p3);

assign sext_ln311_fu_143_p1 = $signed(trunc_ln_reg_207);

assign tmp_1_fu_183_p4 = {{phi_ln315_reg_121[223:32]}};

assign tmp_2_fu_193_p3 = {{tmp_reg_232}, {tmp_1_fu_183_p4}};

assign trunc_ln311_fu_165_p1 = i_reg_110[2:0];

endmodule //krnl_lstm_write_output
