...
// ==============================================================
`timescale 1ns/1ps
module krnl_lstm_control_s_axi
#(parameter
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_Y_H_DATA_0)
            int_y_h[31:0] <= (WDATA[31:0] & wmask) | (int_y_h[31:0] & ~wmask);
    end
end
