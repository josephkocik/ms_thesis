...
module krnl_lstm_krnl_lstm_unit_Block_split221_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_ready;
input  [31:0] dot_o;
input  [31:0] w_xo_loc_dout;
input   w_xo_loc_empty_n;
output   w_xo_loc_read;
input  [31:0] x_t_dout;
input   x_t_empty_n;
output   x_t_read;
input  [31:0] b_o_loc_dout;
input   b_o_loc_empty_n;
output   b_o_loc_read;
...
reg   [31:0] w_xo_loc_read_reg_64;
reg   [31:0] b_o_loc_read_reg_69;
wire   [31:0] grp_fu_55_p2;
reg   [31:0] mul5_i_i_reg_74;
wire    ap_CS_fsm_state5;
wire    ap_CS_fsm_state6;
wire   [31:0] grp_fu_50_p2;
reg   [31:0] add7_i_i_reg_84;
...
krnl_lstm_fadd_32ns_32ns_32_5_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fadd_32ns_32ns_32_5_full_dsp_1_U2187(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_50_p0),
    .din1(grp_fu_50_p1),
...
always @ (*) begin
    if ((~((b_o_loc_empty_n == 1'b0) | (x_t_empty_n == 1'b0) | (w_xo_loc_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        b_o_loc_read = 1'b1;
    end else begin
        b_o_loc_read = 1'b0;
    end
...
always @ (*) begin
    ap_block_state1 = ((b_o_loc_empty_n == 1'b0) | (x_t_empty_n == 1'b0) | (w_xo_loc_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0));
end

assign ap_return = grp_fu_50_p2;

endmodule //krnl_lstm_krnl_lstm_unit_Block_split221_proc
