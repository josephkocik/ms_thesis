...
module krnl_lstm_p_anonymous_namespace_dot_tree_float_2u_unsigned_int_float_s (
        str_in12_dout,
        str_in12_empty_n,
        str_in12_read,
        str_in23_dout,
...
wire    mul_float_4u_unsigned_int_float_U0_str_in12_read;
wire    mul_float_4u_unsigned_int_float_U0_str_in23_read;
wire   [127:0] mul_float_4u_unsigned_int_float_U0_l_mulStr1_din;
wire    mul_float_4u_unsigned_int_float_U0_l_mulStr1_write;
wire    sum_float_2u_unsigned_int_float_U0_l_mulStr1_read;
wire   [31:0] sum_float_2u_unsigned_int_float_U0_l_dot2_din;
wire    sum_float_2u_unsigned_int_float_U0_l_dot2_write;
...
krnl_lstm_mul_float_4u_unsigned_int_float_s mul_float_4u_unsigned_int_float_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
krnl_lstm_sum_float_2u_unsigned_int_float_s sum_float_2u_unsigned_int_float_U0(
...
krnl_lstm_fifo_w128_d2_S_x6 l_mulStr_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
krnl_lstm_start_for_sum_float_2u_unsigned_int_float_U0 start_for_sum_float_2u_unsigned_int_float_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign l_dot2_din = sum_float_2u_unsigned_int_float_U0_l_dot2_din;

assign l_dot2_write = sum_float_2u_unsigned_int_float_U0_l_dot2_write;
...
assign str_in12_read = mul_float_4u_unsigned_int_float_U0_str_in12_read;

assign str_in23_read = mul_float_4u_unsigned_int_float_U0_str_in23_read;
...
endmodule //krnl_lstm_p_anonymous_namespace_dot_tree_float_2u_unsigned_int_float_s
